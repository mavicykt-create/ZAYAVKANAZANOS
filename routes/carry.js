...
// Get carry requests for user - ВСЕ заявки пользователя
...
// Add/update carry request - СОХРАНЯЕМ в БД
...
// Get ALL print data (все категории) - для сборки
